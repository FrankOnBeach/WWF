...
write.csv(cell.orders1,
          "/Users/maclark/Desktop/Mapping Food Consumption/Managed_DHS_Data/DHS data averaged by cell aggregated food groups 27June2019.csv",
          row.names = FALSE)
...
write.csv(cell.orders2,
          "/Users/maclark/Desktop/Mapping Food Consumption/Managed_DHS_Data/DHS_Data_By_Cell_with_Regression_Dat_AggregatedFoodGroups_27June2019.csv",
          row.names = FALSE)
