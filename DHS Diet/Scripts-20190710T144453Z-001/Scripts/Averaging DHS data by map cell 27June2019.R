...
# Cluster dat
cluster.dat <- 
  read.csv("/Users/maclark/Desktop/Mapping Food Consumption/Managed Regression Data/DHS_averaged_by_cluster_num_23June2019.csv",
...
write.csv(gps.cluster,
          "/Users/maclark/Desktop/Mapping Food Consumption/Managed_DHS_Data/DHS_Regression_Dat_Averaged_by_Cell 23June2019.csv",
          row.names = FALSE)
...
write.csv(cell.orders1,
          "/Users/maclark/Desktop/Mapping Food Consumption/Managed_DHS_Data/DHS data averaged by cell 27June2019.csv",
          row.names = FALSE)
...
write.csv(cell.orders2,
          "/Users/maclark/Desktop/Mapping Food Consumption/Managed_DHS_Data/DHS_Data_By_Cell_with_Regression_Dat_27June2019.csv",
          row.names = FALSE)
